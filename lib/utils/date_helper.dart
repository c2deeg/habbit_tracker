...
class DateHelper {
  ...
  static final appointDateFormatter = DateFormat("dd-MM-yyyy", _locale);
  ...
  static final _expiryMonthCard = DateFormat("MMM", _locale);
  ...
  static String getDateAndTime24(DateTime? dateTime) {
    return _epochDate.format(dateTime?.toLocal() ?? DateTime.now());
  }
  ...
  static String getAppointmentDate(String date) {
    DateTime aDate = appointDateFormatter.parse(date);
    return appointDateFormatter.format(aDate);
  }
